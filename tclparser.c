...
static const char toknames[][16] = {
    ...
    [JIM_EXPROP_LTE] = "LTE",
    [JIM_EXPROP_GTE] = "GTE",
    [JIM_EXPROP_NUMEQ] = "NUMEQ",
    [JIM_EXPROP_NUMNE] = "NUMNE",
    [JIM_EXPROP_BITAND] = "BITAND",
    [JIM_EXPROP_BITXOR] = "BITXOR",
    [JIM_EXPROP_BITOR] = "BITOR",
    [JIM_EXPROP_LOGICAND] = "LOGICAND",
    [JIM_EXPROP_LOGICAND_LEFT] = "LOGICAND_LEFT",
    [JIM_EXPROP_LOGICAND_RIGHT] = "LOGICAND_RIGHT",
    [JIM_EXPROP_LOGICOR] = "LOGICOR",
    [JIM_EXPROP_LOGICOR_LEFT] = "LOGICOR_LEFT",
    [JIM_EXPROP_LOGICOR_RIGHT] = "LOGICOR_RIGHT",
    ...
    [JIM_EXPROP_POW] = "POW",
    [JIM_EXPROP_STREQ] = "STREQ",
    [JIM_EXPROP_STRNE] = "STRNE",
    [JIM_EXPROP_STRIN] = "STRIN",
    [JIM_EXPROP_STRNI] = "STRNI",
    [JIM_EXPROP_NOT] = "NOT",
